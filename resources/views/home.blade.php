...
<body class="min-h-screen">
        ...
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center space-x-6 rtl:space-x-reverse">
                ...
                <div class="hidden lg:flex items-center space-x-6 rtl:space-x-reverse">
                    <a href="#services" class="nav-link text-gray-400">Services</a>
                    @auth
                        <a href="/vendor/dashboard" class="bg-[#0047FF] text-white px-6 py-2 rounded-full font-bold text-sm shadow-lg hover:scale-105 transition">Dashboard</a>
                    @else
                        <a href="/login" class="nav-link text-gray-400">Login</a>
                        <a href="/register" class="bg-golden text-black px-6 py-2 rounded-full font-bold text-sm hover:bg-white transition">Register</a>
                    @endauth
                </div>
            </div>
        </div>
    ...
    <header class="py-28 text-center px-4 relative">
        <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#0047FF]/10 via-transparent to-transparent -z-10"></div>
        ...
        <p class="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto mb-12 font-light leading-relaxed px-6">
    ...
    <section id="services" class="py-24 bg-[#030303] border-t border-gray-900">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                <div class="bg-gray-900/30 p-5 rounded-[2.5rem] border border-gray-800 hover:border-golden transition-all group card-shadow relative overflow-hidden">
    ...
    <footer class="py-16 text-center text-gray-500 bg-black border-t border-gray-900">
        <div class="mb-8 font-black text-xl">
             <span class="text-golden">Affican</span> <span class="text-white">Digital</span>
        </div>
